...
export default function Searchform() {
  ...
  return (
    <div className="w-full flex h-screen items-center justify-center px-4 sm:px-10 lg:px-15">
      <form className="flex bg-[#f0f8ff] h-14 items-center justify-between w-full max-w-3xl rounded-lg shadow-md" onSubmit={(e)=>{handleSubmit(e)}}>
        ...
        <input
          type="text"
          className="flex sm:w-[20px] lg:w-[100%] text-black bg-[#f0f8ff] py-2 px-2 outline-none select-none placeholder-gray-500 ml-2 "
          name="Search"
